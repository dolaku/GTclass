...
db.animals.insert({"name": "Elephant", "numLegs": 4, "class": "mammal","weight": 1200, "whatIWouldReallyCallIt": "Trunks" })

db.animals.insert({"name": "Giraffe", "numLegs": 4, "class": "mammal","weight": 1800, "whatIWouldReallyCallIt": "long neck deer" })

db.animals.insert({"name": "Parrot", "numLegs": 2, "class": "bird","weight": 3, "whatIWouldReallyCallIt": "Pecker" })

db.animals.insert({"name": "Snake", "numLegs": 0, "class": "reptile","weight": 5, "whatIWouldReallyCallIt": "sssssssssss" })
```
